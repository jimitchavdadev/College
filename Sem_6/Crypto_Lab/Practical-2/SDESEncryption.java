...
public class SDESEncryption {
    ...
    public static BitSet bitSetFromString(String binary, int length) {
    ...
    // Prints a BitSet as a binary string
    public static void printBinary(BitSet bits, int length) {
    ...
    public static void main(String[] args) {
        ...
        printBinary(plaintext, 8); // Corrected: Passing length (8)

        BitSet ciphertext = encrypt(plaintext, key);
        System.out.print("Ciphertext: ");
        printBinary(ciphertext, 8); // Corrected: Passing length (8)

        BitSet decryptedText = decrypt(ciphertext, key);
        System.out.print("Decrypted plaintext: ");
        printBinary(decryptedText, 8); // Corrected: Passing length (8)
    }
}
