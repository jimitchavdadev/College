...
// P10 Permutation Table (fixed for all 10-bit keys)
vector<int> P10 = {2, 4, 1, 6, 3, 9, 0, 8, 7, 5};

// P8 Permutation Table (fixed for all subkeys)
...
pair<vector<int>, vector<int>> key_generation(const vector<int> &key_10bit)
{
    ...
    // Step 2: Split into two halves (5 bits each)
    ...
    // Second left shift for K2 (2 positions)
